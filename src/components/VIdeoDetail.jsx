      ...
      <Stack direction={{xs: 'column', md:'row'}}>
        <Box flex={1}>
          <Box sx={{width: '100%', position: 'sticky', top: '86px'}}>
            ...
            <Typography variant="h6" color='#fff' fontWeight='bold' p={4}>
              {title}
            </Typography>
            <Stack direction='row' justifyContent='space-between' sx={{color: '#fff'}} py={1} px={3}>
              ...
              <Stack color='#fff' direction='row' gap='20px' alignItems='center'>
                <Typography variant="body1" sx={{opacity: 1}}>
                  {parseInt(viewCount).toLocaleString()} views
                </Typography>
                <Typography color='#fff' variant="body1" sx={{opacity: 1}}>
